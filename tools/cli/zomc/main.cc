...
class CompilerMain {
 public:
  ...
  zc::MainBuilder::Validity setInput(ZC_UNUSED zc::StringPtr inputFile) {
  ...
  zc::MainFunc getMain() {
    return zc::MainBuilder(context, "Compiler v1.0",
                           "Processes input and shows results.")
        .addOptionWithArg({'i', "input"}, ZC_BIND_METHOD(*this, setInput),
